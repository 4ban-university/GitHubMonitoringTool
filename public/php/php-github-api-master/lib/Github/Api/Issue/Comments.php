...
class Comments extends AbstractApi
{
    ...
    public function showAll($username, $repository, array $params){
        $com = $this->getHttpClient()->get("repos/$username/$repository/issues/comments");
        return ResponseMediator::getContent($com);
        //return $this->get('/repos/'.rawurlencode($username).'/'.rawurlencode($repository).'/issues/comments', $params
       // );
    }
