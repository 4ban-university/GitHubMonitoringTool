                    ...
                    <div class="mdl-cell mdl-cell--10-col">
                        ...
                        <section class="mdl-layout__tab-panel is-active" id="scroll-tab-1">
                            <div class="page-content">
                                <!-- repo description and collaborators -->
                                <div class="mdl-grid">
                        ...
                        <section class="mdl-layout__tab-panel" id="scroll-tab-2">
                            <div class="page-content">
                                ...
                                <div class="mdl-grid">
                                    <div class="mdl-cell mdl-cell--4-col margin-none">
                                        <label class="mdl-checkbox mdl-js-checkbox mdl-js-ripple-effect" for="checkbox-1">
                                            <input type="checkbox" id="commitsPerCollaboratorCheck" class="mdl-checkbox__input" name="commitsPerCollaborator" value="a1" checked />
                                            <span class="mdl-checkbox__label">Commits per collaborator</span>
                                        </label>
                                    </div>
                                    <div class="mdl-cell mdl-cell--4-col margin-none">
                                        <label class="mdl-checkbox mdl-js-checkbox mdl-js-ripple-effect" for="checkbox-2">
                                            <input type="checkbox" id="issuesPerCollaboratorCheck" class="mdl-checkbox__input" name="issuesPerCollaborator" value="a2" checked />
                                            <span class="mdl-checkbox__label">Issues per collaborator</span>
                                        </label>
                                    </div>
                                    <div class="mdl-cell mdl-cell--4-col margin-none">
                                        <label class="mdl-checkbox mdl-js-checkbox mdl-js-ripple-effect" for="checkbox-3">
                                            <input type="checkbox" id="commentsPerCollaboratorCheck" class="mdl-checkbox__input" name="commentsPerCollaborator" value="a3" checked />
                                            <span class="mdl-checkbox__label">Comments per collaborator</span>
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="mdl-grid">
                                    <div class="mdl-cell mdl-cell--4-col margin-none">
                                        <label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" for="option-1">
                                            <input type="radio" id="TextData" class="mdl-radio__button" name="dataDisplayForm" >
                                            <span class="mdl-radio__label">Show data only in tables</span>
                                        </label>
                                    </div>
                                    <div class="mdl-cell mdl-cell--4-col margin-none">
                                        <label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" for="option-1">
                                            <input type="radio" id="GraphicData" class="mdl-radio__button" name="dataDisplayForm" >
                                            <span class="mdl-radio__label">Show data only in charts</span>
                                        </label>
                                    </div>
                                    <div class="mdl-cell mdl-cell--4-col margin-none">
                                        <label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" for="option-1">
                                            <input type="radio" id="MixedData" class="mdl-radio__button" name="dataDisplayForm" checked />
                                ...
                                <hr>
                                <div class="chart" id="commitsChart"><!-- Commits -->
                                    <h3>Number of commits per collaborator</h3>
                                    <div class="mdl-grid">
                                        <div class="mdl-cell mdl-cell--6-col margin-none">
                                ...
                                <div class="chart" id="issuesChart"> <!-- Issues -->
                                ...
                                <div class="chart" id="commetsChart"><!-- comments -->
