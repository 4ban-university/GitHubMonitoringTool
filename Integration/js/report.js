...
function tables(commitsPerCollaborator, commentsPerCollaborator, issuesPerCollaborator){
	commitsPerCollaborator.then(function(commitsPerCollaborator){
		...
		var table = "<table class='tbl'><tr class='tr_s'><th class='th_s'>Name</th><th class='th_s'>Number of commits <a class='sortCommits' style='width:50px; height:50px; cursor:pointer'>Sort table</a></th><th class='th_s'>Percentage</th></tr>"
		for (var key in commitsPerCollaborator) {
	...
	issuesPerCollaborator.then(function(issuesPerCollaborator){
		...
		var table = "<table class='tbl'><tr class='tr_s'><th class='th_s'>Name</th><th class='th_s'>Number of issues <a class='sortIssues' style='width:50px; height:50px; cursor:pointer'>Sort table</a></th><th class='th_s'>Percentage</th></tr>"
		for (var key in issuesPerCollaborator) {
	...
	commentsPerCollaborator.then(function(commentsPerCollaborator){
		...
		var table = "<table class='tbl'><tr class='tr_s'><th class='th_s'>Name</th><th class='th_s'>Number of comments <a class='sortComments' style='width:50px; height:50px; cursor:pointer'>Sort table</a></th><th class='th_s'>Percentage</th></tr>"
		for (var key in commentsPerCollaborator) {
